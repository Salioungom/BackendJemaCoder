...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('hackathons', function (Blueprint $table) {
            ...
            $table->string('prix');
            $table->string('lieu');
            $table->integer('countNbrParticipant')->nullable();
            $table->enum('status', ['inscriptions ouvert', 'inscriptions férmées', 'hackathon terminée','hackathon annulée'])->defaultValue('inscriptions ouvert');
